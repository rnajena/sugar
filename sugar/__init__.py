...
from sugar._io.fastaindex import FastaIndex
from sugar import data, _io, web
import os as __os
__sphinx = __os.environ.get('SPHINX_BUILD') == '1'

_io.util._insert_format_plugin_table('seqs', 'in', fancy=__sphinx)(read)
_io.util._insert_format_plugin_table('seqs', 'out', fancy=__sphinx)(BioBasket.write)
_io.util._insert_format_plugin_table('fts', 'in', fancy=__sphinx)(read_fts)
_io.util._insert_format_plugin_table('fts', 'out', fancy=__sphinx)(FeatureList.write)
if __doc__ is not None:
    _original_doc = __doc__
    __doc__ = __doc__.format(
        format_table_seqs=_io.util._create_format_plugin_table('seqs', 'io', fancy=__sphinx),
        format_table_fts=_io.util._create_format_plugin_table('fts', 'io', fancy=__sphinx)
        )
